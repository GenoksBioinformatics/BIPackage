...
def main():
    ...
    parser.add_argument("--input_r1", required=True,
                        help="Path to the undetermined R1 FASTQ.gz file.")
    parser.add_argument("--input_r2", required=True,
                        help="Path to the undetermined R2 FASTQ.gz file.")
