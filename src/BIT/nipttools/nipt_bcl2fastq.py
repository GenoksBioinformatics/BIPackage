...
class NIPTBcl2Fastq:
    ...
    def __init__(self, output_folder,
                 ...
                 compression_level, fastq_file_names, nipt_part, nipt_folders):
    ...
    def upload_file_secure(self, ftp_server="transfer.ctit.eurofinseu.com", ftp_user="tr_genoks", ftp_password="N:If&iZR4cxPg2"):
...
def parse_args():
    ...
    parser.add_argument("-nipt_folders", "--nipt-folders", nargs = "+", type=str, help= "Nipt folders", required=True)
...
if __name__ == "__main__":
    ...
    nipt = NIPTBcl2Fastq(
        ...
        args.fastq_names, args.nipt_part, args.nipt_folders
    )
