...
class CoverageAnalysis:
    ...
    def process(self):
        ...
        try:
            ...
            logging.error(f"An error occurred while processing {self.sample_name}: {e}", exc_info=True)
            


ref_fasta = "/home/genwork2/Mert/01.REFGEN/GRCh38/hg38.fa"
bed_file = "/mnt/gen100/11.bed_files/27.MT_panel/Twist_MitoPanel_chrM_all_hg38_target.bed"
at = "bwtsw"
out_path = "/home/genwork2/Mert/secondaryreqs"
r1 = "/mnt/gen100/01.fastq_files/203.TWIST-ExoV2-DNAPrepWithExomePlus-NovaSeq-RUN193_fastq_files/RUN193-IlluminaTekgenler/Mtpanel-DENEME/AR-Mil86-3738DENEME/MTPANELDENEME_S111_L004_R1_001.fastq.gz"
r2 = "/mnt/gen100/01.fastq_files/203.TWIST-ExoV2-DNAPrepWithExomePlus-NovaSeq-RUN193_fastq_files/RUN193-IlluminaTekgenler/Mtpanel-DENEME/AR-Mil86-3738DENEME/MTPANELDENEME_S111_L004_R2_001.fastq.gz"
sample_name = "MT-PanelDeneme"
threads = 40
remove_dups = False
...
mapit = Mapper(reference_fasta=ref_fasta, sample_id=sample_name, r1=r1, r2=r2, output_path=out_path, threads=threads)
sam_file= mapit.map()

dedup = BAMConverter(sam_path=sam_file, sample_id=sample_name, threads=threads, remove_all_duplicates=remove_dups, remove_sequencing_duplicates=remove_seq_dups, use_mark_duplicates=use_md)
final_bam, out_path_metrics = dedup.convert_markdedup()

coverage_analysis = CoverageAnalysis(reference=ref_fasta, bam = final_bam, sample_id=sample_name, output_dir=out_path_metrics, bed = bed_file, max_worker=threads)
